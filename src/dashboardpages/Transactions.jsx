...
//          <thead >
//             <tr className="flex justify-between border-b items-center text-center py-3 font-bold">
          ...
          <div className="bg-[#FFFFFF] p-6">
            <table className="w-full text-[#202223]">
              ...
              <tbody>
                {transactionDetails.map((detail, key) => {
                  return (
                    <tr key={key} className="text-center py-3 border-b">
                      <td className="font-bold px-4 py-2">{detail.id}</td>
                      <td className="font-medium px-4 py-2">{detail.amount}</td>
                      <td className="font-medium px-4 py-2">{detail.status}</td>
                      <td className="font-medium pl-56 py-2">{detail.method}</td>
                      <td className="font-medium px-4 py-2">{detail.date}</td>
                    </tr>
                  );
                })}
              </tbody>
